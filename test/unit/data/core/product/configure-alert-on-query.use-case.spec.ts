...
import { ConfigureAlertOnQueryUseCase } from 'src/data/core/product/configure-alert-on-query.use-case';
...
describe('ConfigureAlertOnQueryUseCase', () => {
  let sut: ConfigureAlertOnQueryUseCase;
  ...
  beforeEach(async () => {
      ...
      providers: [
        {
          ...
          useClass: ConfigureAlertOnQueryUseCase,
        },
        {
    ...
    sut = module.get(ConfigureAlertOnQueryDomain);
