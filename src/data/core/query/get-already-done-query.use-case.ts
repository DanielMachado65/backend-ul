...
export class GetAlreadyDoneQueryUseCase implements GetAlreadyDoneQueryDomain {
  ...
  getAlreadyDoneQuery(queryId: string, clientType: ClientType): GetAlreadyDoneQueryIO {
